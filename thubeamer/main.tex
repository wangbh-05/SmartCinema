...
\subsection{模块3：影院热度地图}

\begin{frame}{模块3：从离散座位到连续热力场}
  \begin{columns}[T,onlytextwidth]
...
\subsection{模块2：跨端 Canvas 选座}

\begin{frame}{模块2：同一座位图，适配两种交互语言}
  \begin{columns}[T,onlytextwidth]
...
\subsection{模块1：智能推荐选座}

\begin{frame}{模块1：约束优先的可解释连座推荐}
  \centering
...
\begin{frame}{AI 顾问：让 AI 理解偏好，但不替代规则}
  \begin{columns}[T,onlytextwidth]
    \column{0.42\textwidth}
      \centering
      \begin{tikzpicture}[font=\small, node distance=4mm]
