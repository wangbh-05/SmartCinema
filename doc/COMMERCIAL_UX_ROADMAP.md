...
- [ ] 恢复刷新中的有效 hold，补全订单状态时间线、取消/退款资格与二维码。
...
1. 深化 Phase 4：让有效 hold 与 BookingDraft 在刷新后可恢复，并为并发冲突提供失效座位定位和一键重选；
2. 完成场次政策驱动的取消/退款用例、订单时间线与电子票二维码；
3. 推进 Phase 5：把设置/辅助功能迁到账户，把模拟、备份与后台迁到内部工具入口；
...
- Node 全量测试：139/139 PASS（原 105 项全部保留，新增 34 项商业领域/存储/应用/组合契约）。
...
- 浏览器商业流程契约：12/12 PASS、0 XFAIL、0 XPASS、0 ERROR；
