...
| 层级 | 结果 | 主要覆盖 |
| --- | ---: | --- |
| Node | 85/85 | v1/v2 迁移兼容 + 7 部影片/3 家影院/三日滚动排期与 100/200/300 座目录、Money、1–20 张票/同行草稿、情侣隐私推荐、人群规则、四维座位决策、热度参考、报价、hold、订单/退款快照、辅助偏好、Storage v3、恢复、应用、运维权限、组合根与架构边界 |
