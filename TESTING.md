...
| 浏览器 | 16/16 | 新生产入口、票座一致、无障碍门控、锁座跨刷新恢复/冲突/释放、访客确认、幂等退票、辅助偏好、响应式、Dialog、键盘、内部工具边界、DOM 安全、运行时健康 |
...
15. `ARCH-001`：内部操作台显式标记、禁止索引，生产页不暴露其入口；
16. `QA-001`：核心流程 0 个未处理 error/unhandledrejection。
