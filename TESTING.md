...
| 层级 | 结果 | 主要覆盖 |
| --- | ---: | --- |
| Node | 139/139 | v2 既有契约 + 商业目录、Money、票种/草稿、座位规则、报价、hold、订单快照、Storage v3、迁移、应用与组合根 |
| 浏览器 | 12/12 | 新生产入口、票座一致、无障碍门控、锁座释放、访客确认、幂等、响应式、Dialog、键盘、DOM 安全、运行时健康 |
...
4. `UX-004`：关闭确认页会 release 整组 hold 和库存映射；
...
刷新恢复有效 BookingDraft/SeatHold、并发冲突一键重选、取消/退款、二维码、真实支付、多日目录、内部工具拆分、真实读屏和完整辅助模式人工验收仍在商业路线图后续阶段。
